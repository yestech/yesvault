...
import org.yestech.vault.objectmodel.User;
...
public class YesVaultModule
{
            ...
            MappedConfiguration<String, String> configuration)
    {
        ...
        configuration.add("tapestry.default-stylesheet", "org/yestech/yestechlayout.css");
    }
    ...
    {
        ApplicationStateCreator<IUser> creator = new ApplicationStateCreator<IUser>()
        {
            public IUser create()
            {
                return new User();
        ...
        configuration.add(IUser.class, new ApplicationStateContribution("session", creator));
    }
